...
public class Cosine_Similarity {
    ...
    public static void main(String[] args) throws IOException {
         ...
         Document doc = Jsoup.connect("https://en.wikipedia.org/wiki/Meme").get();
        String link = doc.body().text();        
        
        
        Document doc2 = Jsoup.connect("https://en.wikipedia.org/wiki/Aloma_of_the_South_Seas_(1941_film)").get();
        String link2 = doc2.body().text();
        
        
        
        Cosine_Similarity cs1 = new Cosine_Similarity();
        System.out.println("[Word # VectorA # VectorB]");
        double sim_score = cs1.Cosine_Similarity_Score(link, link2);
